...
{
	//default parameters, dont look at them
	string dir = "";
	...
	string patternFile = ""; // patternsto monitor file
	...
	auryn_init( ac, av, dir, "sim_script", file_prefix );
	...
	// Connections between excitary neurons and inhibitatry neurons doesn't undergo long term plasticity but only short term plasticity
	...
	// connection between inhibitory neurons doesn't undergo any king of plasticity
